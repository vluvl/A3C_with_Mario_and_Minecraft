...
def get_args():
    ...
    parser.add_argument("--action_type", type=str, default="simple") # was complex
    parser.add_argument('--lr', type=float, default=1e-4) # was 1e-4, but it works better with 5
    parser.add_argument('--gamma', type=float, default=0.9, help='discount factor for rewards')
    parser.add_argument('--tau', type=float, default=1.0, help='parameter for GAE')
    parser.add_argument('--beta', type=float, default=0.01, help='entropy coefficient')
    parser.add_argument("--num_local_steps", type=int, default=50)
    parser.add_argument("--num_global_steps", type=int, default=5e6) # was 5e6
    parser.add_argument("--num_processes", type=int, default=12) # was 6
